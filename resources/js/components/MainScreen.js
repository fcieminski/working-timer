            ...
            <main className="main">
                ...
                <section className="main__container--features">
                    <div className="features__box">
                        ...
                        <h2 className="features__box--h2">
                            Rozpocznij swoje zadanie
                        </h2>
                        <p className="features__box--paragraph">
                            ustal czas, w którym zajmiesz się jedynie swoim
                            zadaniem. Niech nikt Ci nie przeszkadza!
                        </p>
                    </div>
                    <div className="features__box">
                        ...
                        <p className="features__box--paragraph">
                            po zalogowaniu, otrzymasz dostęp do podsumowania
                            czasu pracy
                        </p>
                    </div>
                    <div className="features__box">
                        ...
                        <h2 className="features__box--h2">
                            Twój tygodniowy czas pracy
                        </h2>
                        <p className="features__box--paragraph">
                            skorzystaj z kalendarza, aby sprawdzić łączy czas
                            pracy przez cały tydzień
                        </p>
                    </div>
                    <FiClock
                        stroke-width="1"
                        className="features__box--backgroundicon"
                    />
                </section>
                            ...
                            <>
                                ...
                                <div className="timer__about">
                                    <h2 className="timer__about--h2">
                                        Timey jest dostępny również bez
                                        logowania
                                    </h2>
                                    <p className="timer__about--paragraph">
                                        jeśli się nie zalogujesz, otrzymasz
                                        dostęp jedynie do timera. Wystarczy, że
                                        wprowadzisz czas pracy, a następnie
                                        zaczniesz robić swoje. Pamiętaj, aby nic
                                        Cię nie rozpraszało, to Twój czas na
                                        wykonanie zadania
                                    </p>
                                    <a
                    ...
                    <div className="about__container">
                        ...
                        >
                            <p className="paragraph--background">
                                <span>
                                    Dodaj tytuł zadania, czas w jakim planujesz
                                    je wykonać oraz opis
                                </span>
                            </p>
                            <img src={arrow} />
                        </div>
                        ...
                        >
                            <img
                                src={arrow}
                                className="paragraph__image--transform"
                            />
                            <p className="paragraph--background">
                                <span>
                        ...
                        >
                            <p className="paragraph--background">
                                <span>
                                    Jeśli wykonasz zadanie szybciej, możesz je
                                    przerwać i dodać do swojej listy
                                    tygodniowych zadań
                                </span>
                            </p>
                            <img src={arrow} />
